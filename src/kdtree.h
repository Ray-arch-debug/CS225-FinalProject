...
class KDTree
{
  ...
  public:
     ...
     * points will be added to vector.
     * @return A vector of all points within the allowable distance. The order
  ...
  private:
     ...
     */
     ...
     unsigned quickSelect(vector<Point<Dim>>& newPoints, unsigned dim_index, unsigned mid, unsigned start, unsigned end);
